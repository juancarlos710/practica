...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	glPushMatrix();
		...
		// pata izquierda delante
		glPushMatrix();

			glTranslatef(-1.5, -6.0, 3.5);
