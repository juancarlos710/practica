...
float pos_camX = 0, pos_camY = 0, pos_camZ = -10; 
...
CTexture t_Muro_madera;
CTexture t_Puerta;
CTexture t_Ventana;
CTexture t_Tejado_Madera;

int font=(int)GLUT_BITMAP_TIMES_ROMAN_24;

void InitGL ( GLvoid )     // Inicializamos parametros
{
	glClearColor(0.2f, 0.4f, 0.7f, 0.0f);				// Azul de fondo	
	...
	t_Muro_madera.LoadTGA("Muro.tga");
	t_Muro_madera.BuildGLTexture();
	t_Muro_madera.ReleaseImage();
	...
	t_Tejado_Madera.LoadTGA("Tejado.tga");
	t_Tejado_Madera.BuildGLTexture();
	t_Tejado_Madera.ReleaseImage();
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(pos_camX, pos_camY, pos_camZ);
		...
		glPushMatrix(); 
			...
			prisma(t_Muro_madera.GLindex, t_Muro_madera.GLindex);
		glPopMatrix();
		glPushMatrix();
			glTranslatef(2.375, 2.625, 0.0);
			glScalef(0.25, 5.0, 5.0);
			prisma(t_Muro_madera.GLindex, t_Muro_madera.GLindex);
		glPopMatrix();
		glPushMatrix();
			glTranslatef(-2.375, 2.625, 0.0);
		...
		glPopMatrix();
		glPushMatrix();
			glTranslatef(0.0, 2.625, -2.375);
			glScalef(4.5, 5.0, 0.25);
			prisma(t_Muro_madera.GLindex, t_Muro_madera.GLindex);
		glPopMatrix();

		// Puerta
		glPushMatrix();
			glTranslatef(-1.0, 2.125, 2.375);
			glScalef(1.5, 4.0, 0.0);
			prisma(t_Puerta.GLindex, t_Puerta.GLindex);
		glPopMatrix();

		// Ventana
		glPushMatrix();
			glTranslatef(1.0, 3.125, 2.375);
			glScalef(1.0, 1.0, 0.0);
			prisma(t_Ventana.GLindex, t_Ventana.GLindex);
		glPopMatrix();

		glPushMatrix();
			glTranslatef(-2.0, 2.625, 2.375);
			glRotatef(180, 0.0, 1.0, 0.0);
			glScalef(0.5, 5.0, 0.25);
			prisma(t_Muro_madera.GLindex, t_Muro_madera.GLindex);
		glPopMatrix();
		glPushMatrix();
			glTranslatef(-1.0, 4.625, 2.375);
			glRotatef(180, 0.0, 1.0, 0.0);
			glScalef(1.5, 1.0, 0.25);
			prisma(t_Muro_madera.GLindex, t_Muro_madera.GLindex);
		glPopMatrix();
		glPushMatrix();
			glTranslatef(0.125, 2.625, 2.375);
			glRotatef(180, 0.0, 1.0, 0.0);
			glScalef(0.75, 5.0, 0.25);
			prisma(t_Muro_madera.GLindex, t_Muro_madera.GLindex);
		glPopMatrix();
		glPushMatrix();
			glTranslatef(1.0, 1.375, 2.375);
			glRotatef(180, 0.0, 1.0, 0.0);
			glScalef(1.0, 2.5, 0.25);
			prisma(t_Muro_madera.GLindex, t_Muro_madera.GLindex);
		glPopMatrix();
		glPushMatrix();
			glTranslatef(1.0, 4.375, 2.375);
			glRotatef(180, 0.0, 1.0, 0.0);
			glScalef(1.0, 1.5, 0.25);
			prisma(t_Muro_madera.GLindex, t_Muro_madera.GLindex);
		glPopMatrix();
		glPushMatrix();
			glTranslatef(1.875, 2.625, 2.375);
			glRotatef(180, 0.0, 1.0, 0.0);
			glScalef(0.75, 5.0, 0.25);
			prisma(t_Muro_madera.GLindex, t_Muro_madera.GLindex);
		glPopMatrix();
		...
		glPushMatrix();
			...
			glScalef(7.0, 0.25, 7.0);
		prisma(t_Tejado_Madera.GLindex, t_Tejado_Madera.GLindex);
		glPopMatrix();
